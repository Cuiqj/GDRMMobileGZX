...
//
//
////static NSString *PASSWORD=@"GslzPC_2016";
...
//                             "  <ds>%@</ds> \n"
//                             "  <tableName>%@</tableName> \n "
//                             " </uploadDataSet> \n",PASSWORD,xmlDataFile,currentDataName];
//    [self executeWebService:@"uploadDataSet" serviceParm:soapMessage];
//}
//
...
//
////-(void)getOrgInfo{
////    NSString *soapMessage = [[NSString alloc] initWithFormat:@" <getOrgList xmlns=\"http://tempuri.org/IrmsData/MobileData\"> \n"
////                             "  <key>%@</key> \n"
////                             " </getOrgList> \n",PASSWORD];
////    [self executeWebService:@"getOrgList" serviceParm:soapMessage];
////    
...
//
//-(void)getOrgInfo{
//    NSString *soapMessage=[NSString stringWithFormat:@"<getOrgInfo xmlns=\"http://tempuri.org/IrmsData/MobileData\"> \n"
//                           "  <key>%@</key> \n"
//                           " </getOrgInfo> \n",PASSWORD];
//    [self executeWebService:@"getOrgList" serviceParm:soapMessage];
//
...
//                           "</soapenv:Envelope>",parms];
//    NSString *urlString=[[[AppDelegate App] serverAddress] stringByAppendingString:@"/MobileData.asmx"];
//    //NSString *urlString=[[AppDelegate App] serverAddress];
//    NSURL *url=[NSURL URLWithString:urlString];
//    NSMutableURLRequest *theRequest=[NSMutableURLRequest requestWithURL:url];
//    NSString *msgLength=[NSString stringWithFormat:@"%d",[soapMessage length]];
//    [theRequest addValue: @"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
...
//        if (data.length > 0 && error == nil) {
//            NSString *theXML = [[NSString alloc] initWithBytes: [data bytes] length:[data length] encoding:NSUTF8StringEncoding];
//            //            [self htmlEntityDecode:theXML];
//            NSString *temp=[self htmlEntityDecode:theXML];
//            [self.delegate getWebServiceReturnString:temp forWebService:serviceName];
//        } else if (error != nil && error.code == NSURLErrorTimedOut) {
//            [self.delegate requestTimeOut];
//        } else if (error != nil) {
//            [self.delegate requestUnkownError];
