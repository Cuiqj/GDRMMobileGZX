...
- (void)pageSaveInfo{
    //案由
    self.stopNoticeInfo.number = self.textnumber.text;
    self.stopNoticeInfo.disobey_item=self.textdisobey_item.text;
    //self.stopNoticeInfo.alter_item=self.textalter_item.text;
    self.stopNoticeInfo.obey_tiao=self.textobey_tiao.text;
    self.stopNoticeInfo.obey_kuan=self.textobey_kuan.text;
    self.stopNoticeInfo.money=self.textmoney.text;
