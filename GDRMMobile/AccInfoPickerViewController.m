...
-(void)viewWillAppear:(BOOL)animated{
    switch (self.pickerType) {
        ...
        case 11:
            //事故类型
            self.data=[Systype typeValueForCodeName:@"车辆碰撞部位"];
            break;
        case 12:
            //事故类型
            self.data=[Systype typeValueForCodeName:@"车辆碰撞物体"];
            break;
        case 13:
            //事故类型
            self.data=[Systype typeValueForCodeName:@"车辆碰撞后状态"];
            break;
        case 14:
            //事故类型
            self.data=[Systype typeValueForCodeName:@"车辆停靠位置"];
            break;
        case 15:
            //事故类型
            self.data=[Systype typeValueForCodeName:@"车头朝向"];
            break;
        case 16:
            //事故类型
            self.data=[Systype typeValueForCodeName:@"车身位置"];
            break;
        case 17:
            //事故类型
            self.data=[Systype typeValueForCodeName:@"尾部位置"];
            break;
        case 18:
            //事故类型
            self.data=[Systype typeValueForCodeName:@"车辆外观描述"];
            break;
        case 22:
            //事故类型
